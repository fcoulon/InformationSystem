...
public class DatabaseMatchEngineFactory extends MatchEngineFactoryImpl {
	...
	private static final CachingDistance cachedDistance = new CachingDistance(editionDistance);
	private static final IEObjectMatcher matcher = new ProximityEObjectMatcher(cachedDistance);
	...
	public static IEObjectMatcher getDatabaseEObjectMatcher() {
		return matcher;
	}
